...
$conn = new XMPPHP_XMPP('talk.google.com', 5222, 'ju.delsescaux@gmail.com', '1664isgood', 'xmpphp', 'gmail.com', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
//$conn = new XMPPHP_XMPP('jabber.rueducommerce.fr', 5222, 'julien.delsescaux@jabber.rueducommerce.fr', '1664isgood', 'xmpphp', 'jabber.rueducommerce.fr', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
    	...
    	foreach($payloads as $event) {
    		...
    		switch($event[0]) {
    			case 'message': 
    				...
    				print $pl['body'] . "\n";
    				print "---------------------------------------------------------------------------------\n";
    				$conn->message($pl['from'], $body="hello world.", $type=$pl['type']);
					$cmd = explode(' ', $pl['body']);
